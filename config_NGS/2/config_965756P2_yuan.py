...
Pair_File = [['/home/wanguan2000/Project_fastq/backup/20111108/i965756P2/i965756P2_R1.fastq','/home/wanguan2000/Project_fastq/backup/20111108/i965756P2/i965756P2_R2.fastq'],]

###Pair Info list#########

Pair_Info = [['RGID=965756P2', 'RGLB=965756P2', 'RGPL=illumina', 'RGPU=HWI-ST966', 'RGSM=965756P2', 'RGCN=wuxiapp', 'RGDS=xenograft'],]


#[output_folder]
Output_Folder = '/home/wanguan2000/NGSToolkit/result_NGS/reuslt_965756P2_yuan'
#[cpu_no]
cpu = '8'
#[memory]
memory = '-Xmx20g'
