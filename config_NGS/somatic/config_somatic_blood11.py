...
#######
somatic_samples = [
    '/gpfs/home/wanguan2000/NGSToolkit/result_NGS/Sample6Triangle/result_blood11/blood11_R1_blood11_R2_sort_realign_dedup_mate_recal.bam'
    ,
    '/gpfs/home/wanguan2000/NGSToolkit/result_NGS/Sample6Triangle/result_tissue11/tissue11_R1_tissue11_R2_sort_realign_dedup_mate_recal.bam'
    ,
    '/gpfs/home/wanguan2000/NGSToolkit/result_NGS/Sample6Triangle/result_xeno11/xeno11_R1_human_xeno11_R2_human_sort_realign_dedup_mate_recal.bam'
    ,
    ]
#match smaple,the first sample is Normal sample,the rest one is tumor sample.
somatic_pair = [['blood11', 'tissue11'], ['blood11', 'xeno11']]

#[output_folder]
Output_Folder = '/home/wanguan2000/NGSToolkit/result_NGS/Sample6Triangle/somatic/reuslt_somatic_11'
#[cpu_no]
cpu = '10'
#[memory]
memory = '-Xmx30g'
