...
#######
somatic_samples = [
    '/gpfs/home/wanguan2000/NGSToolkit/result_NGS/Sample6Triangle/result_blood16/blood16_R1_blood16_R2_sort_realign_dedup_mate_recal.bam'
    ,
    '/gpfs/home/wanguan2000/NGSToolkit/result_NGS/Sample6Triangle/result_tissue16/tissue16_R1_tissue16_R2_sort_realign_dedup_mate_recal.bam'
    ,
    '/gpfs/home/wanguan2000/NGSToolkit/result_NGS/Sample6Triangle/result_xeno16/xeno16_R1_human_xeno16_R2_human_sort_realign_dedup_mate_recal.bam'
    ,
    ]

#match smaple,the first sample is Normal sample,the rest one is tumor sample.
somatic_pair = [['blood16', 'tissue16'], ['blood16', 'xeno16']]

#[output_folder]
Output_Folder = '/home/wanguan2000/NGSToolkit/result_NGS/Sample6Triangle/somatic/reuslt_somatic_16'
#[cpu_no]
cpu = '10'
#[memory]
memory = '-Xmx30g'
