...
Pair_File = [['/gpfs/home/wanguan2000/Project_fastq/tq/Sample_183138T/Sample_183138T_R1.fastq','/gpfs/home/wanguan2000/Project_fastq/tq/Sample_183138T/Sample_183138T_R2.fastq'],]

###Pair Info list#########


Pair_Info = [['RGID=Sample_183138T', 'RGLB=Sample_183138T', 'RGPL=illumina', 'RGPU=HWI-ST966', 'RGSM=Sample_183138T', 'RGCN=GC', 'RGDS=exon-genome'],]


#[output_folder]
Output_Folder = '/home/wanguan2000/NGSToolkit/result_NGS/tq/result_Sample_183138T'
#[cpu_no]
cpu = '6'
#[memory]
memory = '-Xmx15g'
