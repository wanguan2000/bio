...
Pair_File = [['/gpfs/home/wanguan2000/Project_fastq/tq/Sample_183138M/Sample_183138M_R1.fastq','/gpfs/home/wanguan2000/Project_fastq/tq/Sample_183138M/Sample_183138M_R2.fastq'],]

###Pair Info list#########


Pair_Info = [['RGID=Sample_183138M', 'RGLB=Sample_183138M', 'RGPL=illumina', 'RGPU=HWI-ST966', 'RGSM=Sample_183138M', 'RGCN=GC', 'RGDS=exon-genome'],]


#[output_folder]
Output_Folder = '/home/wanguan2000/NGSToolkit/result_NGS/tq/result_Sample_183138M'
#[cpu_no]
cpu = '6'
#[memory]
memory = '-Xmx15g'
