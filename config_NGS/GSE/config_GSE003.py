...
Pair_File = [['/gpfs/home/wanguan2000/Project_fastq/GSE/GSE003/GSE003_R1.fastq','/gpfs/home/wanguan2000/Project_fastq/GSE/GSE003/GSE003_R2.fastq'],]

###Pair Info list#########


Pair_Info = [['RGID=GSE003', 'RGLB=GSE003', 'RGPL=illumina', 'RGPU=HWI-ST966', 'RGSM=GSE003', 'RGCN=wuxiapp', 'RGDS=exon-genome'],]


#[output_folder]
Output_Folder = '/home/wanguan2000/NGSToolkit/result_NGS/GSE/result_GSE003'
#[cpu_no]
cpu = '6'
#[memory]
memory = '-Xmx15g'
