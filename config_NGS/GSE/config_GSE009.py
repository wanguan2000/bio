...
Pair_File = [['/gpfs/home/wanguan2000/Project_fastq/GSE/GSE009/GSE009_R1.fastq','/gpfs/home/wanguan2000/Project_fastq/GSE/GSE009/GSE009_R2.fastq'],]

###Pair Info list#########


Pair_Info = [['RGID=GSE009', 'RGLB=GSE009', 'RGPL=illumina', 'RGPU=HWI-ST966', 'RGSM=GSE009', 'RGCN=wuxiapp', 'RGDS=exon-genome'],]


#[output_folder]
Output_Folder = '/home/wanguan2000/NGSToolkit/result_NGS/GSE/result_GSE009'
#[cpu_no]
cpu = '6'
#[memory]
memory = '-Xmx15g'
