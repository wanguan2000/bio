...
Pair_File = [['/gpfs/home/wanguan2000/Project_fastq/GSE/GSE006/GSE006_R1.fastq','/gpfs/home/wanguan2000/Project_fastq/GSE/GSE006/GSE006_R2.fastq'],]

###Pair Info list#########


Pair_Info = [['RGID=GSE006', 'RGLB=GSE006', 'RGPL=illumina', 'RGPU=HWI-ST966', 'RGSM=GSE006', 'RGCN=wuxiapp', 'RGDS=exon-genome'],]


#[output_folder]
Output_Folder = '/home/wanguan2000/NGSToolkit/result_NGS/GSE/result_GSE006'
#[cpu_no]
cpu = '6'
#[memory]
memory = '-Xmx15g'
