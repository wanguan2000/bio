...
Pair_File = [['/gpfs/home/wanguan2000/Project_fastq/GSE/GSE014/GSE014_R1.fastq','/gpfs/home/wanguan2000/Project_fastq/GSE/GSE014/GSE014_R2.fastq'],]

###Pair Info list#########


Pair_Info = [['RGID=GSE014', 'RGLB=GSE014', 'RGPL=illumina', 'RGPU=HWI-ST966', 'RGSM=GSE014', 'RGCN=wuxiapp', 'RGDS=exon-genome'],]


#[output_folder]
Output_Folder = '/home/wanguan2000/NGSToolkit/result_NGS/GSE/result_GSE014'
#[cpu_no]
cpu = '6'
#[memory]
memory = '-Xmx15g'
