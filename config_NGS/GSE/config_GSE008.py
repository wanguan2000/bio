...
Pair_File = [['/gpfs/home/wanguan2000/Project_fastq/GSE/GSE008/GSE008_R1.fastq','/gpfs/home/wanguan2000/Project_fastq/GSE/GSE008/GSE008_R2.fastq'],]

###Pair Info list#########


Pair_Info = [['RGID=GSE008', 'RGLB=GSE008', 'RGPL=illumina', 'RGPU=HWI-ST966', 'RGSM=GSE008', 'RGCN=wuxiapp', 'RGDS=exon-genome'],]


#[output_folder]
Output_Folder = '/home/wanguan2000/NGSToolkit/result_NGS/GSE/result_GSE008'
#[cpu_no]
cpu = '6'
#[memory]
memory = '-Xmx15g'
