...
Pair_File = [['/gpfs/home/wanguan2000/Project_fastq/GSE/GSE001/GSE001_R1.fastq','/gpfs/home/wanguan2000/Project_fastq/GSE/GSE001/GSE001_R2.fastq'],]

###Pair Info list#########


Pair_Info = [['RGID=GSE001', 'RGLB=GSE001', 'RGPL=illumina', 'RGPU=HWI-ST966', 'RGSM=GSE001', 'RGCN=wuxiapp', 'RGDS=exon-genome'],]


#[output_folder]
Output_Folder = '/home/wanguan2000/NGSToolkit/result_NGS/GSE/result_GSE001'
#[cpu_no]
cpu = '6'
#[memory]
memory = '-Xmx15g'
