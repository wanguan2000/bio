...
Pair_File = [['/gpfs/home/wanguan2000/Project_fastq/GSE/GSE005/GSE005_R1.fastq','/gpfs/home/wanguan2000/Project_fastq/GSE/GSE005/GSE005_R2.fastq'],]

###Pair Info list#########


Pair_Info = [['RGID=GSE005', 'RGLB=GSE005', 'RGPL=illumina', 'RGPU=HWI-ST966', 'RGSM=GSE005', 'RGCN=wuxiapp', 'RGDS=exon-genome'],]


#[output_folder]
Output_Folder = '/home/wanguan2000/NGSToolkit/result_NGS/GSE/result_GSE005'
#[cpu_no]
cpu = '6'
#[memory]
memory = '-Xmx15g'
