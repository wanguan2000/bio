...
Pair_File = [['/gpfs/home/wanguan2000/Project_fastq/GSE/GSE013/GSE013_R1.fastq','/gpfs/home/wanguan2000/Project_fastq/GSE/GSE013/GSE013_R2.fastq'],]

###Pair Info list#########


Pair_Info = [['RGID=GSE013', 'RGLB=GSE013', 'RGPL=illumina', 'RGPU=HWI-ST966', 'RGSM=GSE013', 'RGCN=wuxiapp', 'RGDS=exon-genome'],]


#[output_folder]
Output_Folder = '/home/wanguan2000/NGSToolkit/result_NGS/GSE/result_GSE013'
#[cpu_no]
cpu = '6'
#[memory]
memory = '-Xmx15g'
