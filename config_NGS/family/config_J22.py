...
Pair_File = [['/gpfs/home/wanguan2000/Project_fastq/cui2/J22/J22_R1.fastq','/gpfs/home/wanguan2000/Project_fastq/cui2/J22/J22_R2.fastq'],]

###Pair Info list#########


Pair_Info = [['RGID=J22', 'RGLB=J22', 'RGPL=illumina', 'RGPU=HWI-ST966', 'RGSM=J22', 'RGCN=GC', 'RGDS=exon-genome'],]


#[output_folder]
Output_Folder = '/home/wanguan2000/NGSToolkit/result_NGS/family/result_J22'
#[cpu_no]
cpu = '6'
#[memory]
memory = '-Xmx15g'
