...
Pair_File = [['/gpfs/home/wanguan2000/Project_fastq/cui2/S7_4/S7_4_R1.fastq','/gpfs/home/wanguan2000/Project_fastq/cui2/S7_4/S7_4_R2.fastq'],]

###Pair Info list#########


Pair_Info = [['RGID=S7_4', 'RGLB=S7_4', 'RGPL=illumina', 'RGPU=HWI-ST966', 'RGSM=S7_4', 'RGCN=GC', 'RGDS=exon-genome'],]


#[output_folder]
Output_Folder = '/home/wanguan2000/NGSToolkit/result_NGS/family/result_S7_4'
#[cpu_no]
cpu = '6'
#[memory]
memory = '-Xmx15g'
