...
Pair_File = [['/gpfs/home/wanguan2000/illumina/L001/analysis/hongquan/gequan_R1.fastq','/gpfs/home/wanguan2000/illumina/L001/analysis/hongquan/gequan_R2.fastq'],]

###Pair Info list#########

Pair_Info = [['RGID=hongquan', 'RGLB=xeno', 'RGPL=illumina', 'RGPU=exno', 'RGSM=xeno', 'RGCN=exno', 'RGDS=exno'],]


#[output_folder]
Output_Folder = '/home/wanguan2000/NGSToolkit/result_NGS/family/reuslt_hongquan'
#[cpu_no]
cpu = '6'
#[memory]
memory = '-Xmx15g'
