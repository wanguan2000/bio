...
#######
somatic_samples = [
    '/gpfs/home/wanguan2000/NGSToolkit/result_NGS/family/result_S7_2/S7_2_R1_S7_2_R2_sort_realign_dedup_mate_recal.bam'
    ,
    '/gpfs/home/wanguan2000/NGSToolkit/result_NGS/family/result_S7_4/S7_4_R1_S7_4_R2_sort_realign_dedup_mate_recal.bam'
    ,
    ]
#match smaple,the first sample is Normal sample,the rest one is tumor sample.
somatic_pair = [['S7_2', 'S7_4'],]

#[output_folder]
Output_Folder = '/gpfs/home/wanguan2000/NGSToolkit/result_NGS/family/somatic/result_S7'
#[cpu_no]
cpu = '10'
#[memory]
memory = '-Xmx30g'
