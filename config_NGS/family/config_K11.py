...
Pair_File = [['/gpfs/home/wanguan2000/Project_fastq/cui2/K11/K11_R1.fastq','/gpfs/home/wanguan2000/Project_fastq/cui2/K11/K11_R2.fastq'],]

###Pair Info list#########


Pair_Info = [['RGID=K11', 'RGLB=K11', 'RGPL=illumina', 'RGPU=HWI-ST966', 'RGSM=K11', 'RGCN=GC', 'RGDS=exon-genome'],]


#[output_folder]
Output_Folder = '/home/wanguan2000/NGSToolkit/result_NGS/family/result_K11'
#[cpu_no]
cpu = '6'
#[memory]
memory = '-Xmx15g'
