...
Pair_File = [['/gpfs/home/wanguan2000/Project_fastq/cui2/J24/J24_R1.fastq','/gpfs/home/wanguan2000/Project_fastq/cui2/J24/J24_R2.fastq'],]

###Pair Info list#########


Pair_Info = [['RGID=J24', 'RGLB=J24', 'RGPL=illumina', 'RGPU=HWI-ST966', 'RGSM=J24', 'RGCN=GC', 'RGDS=exon-genome'],]


#[output_folder]
Output_Folder = '/home/wanguan2000/NGSToolkit/result_NGS/family/result_J24'
#[cpu_no]
cpu = '6'
#[memory]
memory = '-Xmx15g'
