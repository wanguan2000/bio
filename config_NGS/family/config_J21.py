...
Pair_File = [['/gpfs/home/wanguan2000/Project_fastq/cui2/J21/J21_R1.fastq','/gpfs/home/wanguan2000/Project_fastq/cui2/J21/J21_R2.fastq'],]

###Pair Info list#########


Pair_Info = [['RGID=J21', 'RGLB=J21', 'RGPL=illumina', 'RGPU=HWI-ST966', 'RGSM=J21', 'RGCN=GC', 'RGDS=exon-genome'],]


#[output_folder]
Output_Folder = '/home/wanguan2000/NGSToolkit/result_NGS/family/result_J21'
#[cpu_no]
cpu = '6'
#[memory]
memory = '-Xmx15g'
