...
Pair_File = [['/gpfs/home/wanguan2000/Project_fastq/6xenograft/blood19/blood19_R1.fastq','/gpfs/home/wanguan2000/Project_fastq/6xenograft/blood19/blood19_R2.fastq'],]

###Pair Info list#########


Pair_Info = [['RGID=blood19', 'RGLB=blood19', 'RGPL=illumina', 'RGPU=HWI-ST966', 'RGSM=blood19', 'RGCN=wuxiapp', 'RGDS=exon-genome'],]


#[output_folder]
Output_Folder = '/home/wanguan2000/NGSToolkit/result_NGS/Sample6Triangle/result_blood19'
#[cpu_no]
cpu = '6'
#[memory]
memory = '-Xmx15g'
