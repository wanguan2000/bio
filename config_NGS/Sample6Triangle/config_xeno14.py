...
Pair_File = [['/gpfs/home/wanguan2000/Project_fastq/6xenograft/xeno/xeno14/xeno14_R1.fastq','/gpfs/home/wanguan2000/Project_fastq/6xenograft/xeno/xeno14/xeno14_R2.fastq'],]

###Pair Info list#########


Pair_Info = [['RGID=xeno14', 'RGLB=xeno14', 'RGPL=illumina', 'RGPU=HWI-ST966', 'RGSM=xeno14', 'RGCN=wuxiapp', 'RGDS=exon-genome'],]


#[output_folder]
Output_Folder = '/home/wanguan2000/NGSToolkit/result_NGS/Sample6Triangle/result_xeno14'
#[cpu_no]
cpu = '6'
#[memory]
memory = '-Xmx15g'
