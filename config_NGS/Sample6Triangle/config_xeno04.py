...
Pair_File = [['/gpfs/home/wanguan2000/Project_fastq/6xenograft/xeno/xeno04/xeno04_R1.fastq','/gpfs/home/wanguan2000/Project_fastq/6xenograft/xeno/xeno04/xeno04_R2.fastq'],]

###Pair Info list#########


Pair_Info = [['RGID=xeno04', 'RGLB=xeno04', 'RGPL=illumina', 'RGPU=HWI-ST966', 'RGSM=xeno04', 'RGCN=wuxiapp', 'RGDS=exon-genome'],]


#[output_folder]
Output_Folder = '/home/wanguan2000/NGSToolkit/result_NGS/Sample6Triangle/result_xeno04'
#[cpu_no]
cpu = '6'
#[memory]
memory = '-Xmx15g'
