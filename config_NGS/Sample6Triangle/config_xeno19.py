...
Pair_File = [['/gpfs/home/wanguan2000/Project_fastq/6xenograft/xeno/xeno19/xeno19_R1.fastq','/gpfs/home/wanguan2000/Project_fastq/6xenograft/xeno/xeno19/xeno19_R2.fastq'],]

###Pair Info list#########


Pair_Info = [['RGID=xeno19', 'RGLB=xeno19', 'RGPL=illumina', 'RGPU=HWI-ST966', 'RGSM=xeno19', 'RGCN=wuxiapp', 'RGDS=exon-genome'],]


#[output_folder]
Output_Folder = '/home/wanguan2000/NGSToolkit/result_NGS/Sample6Triangle/result_xeno19'
#[cpu_no]
cpu = '6'
#[memory]
memory = '-Xmx15g'
