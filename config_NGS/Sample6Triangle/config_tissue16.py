...
Pair_File = [['/gpfs/home/wanguan2000/Project_fastq/6xenograft/tissue16/tissue16_R1.fastq','/gpfs/home/wanguan2000/Project_fastq/6xenograft/tissue16/tissue16_R2.fastq'],]

###Pair Info list#########


Pair_Info = [['RGID=tissue16', 'RGLB=tissue16', 'RGPL=illumina', 'RGPU=HWI-ST966', 'RGSM=tissue16', 'RGCN=wuxiapp', 'RGDS=exon-genome'],]


#[output_folder]
Output_Folder = '/home/wanguan2000/NGSToolkit/result_NGS/Sample6Triangle/result_tissue16'
#[cpu_no]
cpu = '6'
#[memory]
memory = '-Xmx15g'
