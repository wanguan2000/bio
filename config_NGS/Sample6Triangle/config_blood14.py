...
Pair_File = [['/gpfs/home/wanguan2000/Project_fastq/6xenograft/blood14/blood14_R1.fastq','/gpfs/home/wanguan2000/Project_fastq/6xenograft/blood14/blood14_R2.fastq'],]

###Pair Info list#########


Pair_Info = [['RGID=blood14', 'RGLB=blood14', 'RGPL=illumina', 'RGPU=HWI-ST966', 'RGSM=blood14', 'RGCN=wuxiapp', 'RGDS=exon-genome'],]


#[output_folder]
Output_Folder = '/home/wanguan2000/NGSToolkit/result_NGS/Sample6Triangle/result_blood14'
#[cpu_no]
cpu = '6'
#[memory]
memory = '-Xmx15g'
