...
Pair_File = [['/gpfs/home/wanguan2000/Project_fastq/6xenograft/tissue12/tissue12_R1.fastq','/gpfs/home/wanguan2000/Project_fastq/6xenograft/tissue12/tissue12_R2.fastq'],]

###Pair Info list#########


Pair_Info = [['RGID=tissue12', 'RGLB=tissue12', 'RGPL=illumina', 'RGPU=HWI-ST966', 'RGSM=tissue12', 'RGCN=wuxiapp', 'RGDS=exon-genome'],]


#[output_folder]
Output_Folder = '/home/wanguan2000/NGSToolkit/result_NGS/Sample6Triangle/result_tissue12'
#[cpu_no]
cpu = '6'
#[memory]
memory = '-Xmx15g'
