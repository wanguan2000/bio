...
Pair_File = [['/gpfs/home/wanguan2000/Project_fastq/6xenograft/tissue11/tissue11_R1.fastq','/gpfs/home/wanguan2000/Project_fastq/6xenograft/tissue11/tissue11_R2.fastq'],]

###Pair Info list#########


Pair_Info = [['RGID=tissue11', 'RGLB=tissue11', 'RGPL=illumina', 'RGPU=HWI-ST966', 'RGSM=tissue11', 'RGCN=wuxiapp', 'RGDS=exon-genome'],]


#[output_folder]
Output_Folder = '/home/wanguan2000/NGSToolkit/result_NGS/Sample6Triangle/result_tissue11'
#[cpu_no]
cpu = '6'
#[memory]
memory = '-Xmx15g'
