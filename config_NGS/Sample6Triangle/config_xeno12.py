...
Pair_File = [['/gpfs/home/wanguan2000/Project_fastq/6xenograft/xeno/xeno12/xeno12_R1.fastq','/gpfs/home/wanguan2000/Project_fastq/6xenograft/xeno/xeno12/xeno12_R2.fastq'],]

###Pair Info list#########


Pair_Info = [['RGID=xeno12', 'RGLB=xeno12', 'RGPL=illumina', 'RGPU=HWI-ST966', 'RGSM=xeno12', 'RGCN=wuxiapp', 'RGDS=exon-genome'],]


#[output_folder]
Output_Folder = '/home/wanguan2000/NGSToolkit/result_NGS/Sample6Triangle/result_xeno12'
#[cpu_no]
cpu = '6'
#[memory]
memory = '-Xmx15g'
