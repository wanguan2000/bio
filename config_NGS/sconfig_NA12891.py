...
Pair_File = [
    ['/home/wanguan2000/Project_fastq/backup/20111108/iNA12891/iNA12891_R1.fastq', '/home/wanguan2000/Project_fastq/backup/20111108/iNA12891/iNA12891_R2.fastq'],
                 ]

###Pair Info list#########

Pair_Info = [
    ['RGID=NA12891', 'RGLB=NA12891', 'RGPL=illumina', 'RGPU=HWI-ST966-59', 'RGSM=NA12891', 'RGCN=wuxiapp', 'RGDS=whole-genome'],
                   ]
#[output_folder]
Output_Folder = '/home/wanguan2000/NGSToolkit/result_NGS/reuslt_NA12891'
#[cpu_no]
cpu = '22'
#[memory]
memory = '-Xmx60g'
...
Root_Database = '/home/wanguan2000/myNGS/'
#####
'''
...
'''
AlignDatabase = Root_Database + 'database_NGS/hg19fastadatabase/indexhg19_bwa/hg19_bwa'
FastaDatabase = Root_Database + 'database_NGS/hg19fastadatabase/ucsc.hg19.fasta'
dbsnp132 = Root_Database + 'database_NGS/hg19_GATK1_1/dbsnp_132.hg19.vcf'

omni = Root_Database + 'database_NGS/hg19_GATK1_1/1000G_omni2.5.hg19.sites.vcf'
hapmap = Root_Database + 'database_NGS/hg19_GATK1_1/hapmap_3.3.hg19.sites.vcf'
indels_mills = Root_Database + 'database_NGS/hg19_GATK1_1/Mills_Devine_2hit.indels.hg19.sites.vcf'
indels_mills_realignment = Root_Database + 'database_NGS/hg19_GATK1_1/Mills_Devine_2hit.indels.hg19.vcf'
indels_1000G_realignment = Root_Database + 'database_NGS/hg19_GATK1_1/1000G_biallelic.indels.hg19.vcf'
...
Root_Software = '/home/wanguan2000/myNGS/'
####
bwa = Root_Software + 'software_NGS/bwa-0.5.9/bwa'
botwie = ''
fastqc = Root_Software + 'software_NGS/FastQC_v0.9.5/fastqc'
dynamictrim = Root_Software + 'software_NGS/DynamicTrim_v.1.10/DynamicTrim.pl'
picard_SamFormatConverter = Root_Software + 'software_NGS/picard-tools-1.50/SamFormatConverter.jar'
picard_AddOrReplaceReadGroups = Root_Software + 'software_NGS/picard-tools-1.50/AddOrReplaceReadGroups.jar'
picard_BuildBamIndex = Root_Software + 'software_NGS/picard-tools-1.50/BuildBamIndex.jar'
picard_MarkDuplicates = Root_Software + 'software_NGS/picard-tools-1.50/MarkDuplicates.jar'
picard_FixMateInformation = Root_Software + 'software_NGS/picard-tools-1.50/FixMateInformation.jar'
picard_BamIndexStats = Root_Software + 'software_NGS/picard-tools-1.50/BamIndexStats.jar'


GATK_last = Root_Software + 'software_NGS/GATK/GenomeAnalysisTK-1.3-24-gc8b1c92/GenomeAnalysisTK.jar'
GATK_1_1_36 = Root_Software + 'software_NGS/GATK/GenomeAnalysisTK-1.1-36-g367bbee/GenomeAnalysisTK.jar'
