...
GATK_last = Root_Software + 'software_NGS/GATK/GenomeAnalysisTK-1.6-13-g91f02df/GenomeAnalysisTK.jar'
BEDTools = Root_Software + 'software_NGS/BEDTools-Version-2.16.2/bin/'
