...
#######
somatic_samples = [
'/gpfs2/home/wanguan2000/result2_NGS/xh/result_A3/A3_R1_A3_R2_sort.bam',
'/gpfs2/home/wanguan2000/result2_NGS/xh/result_B3/B3_R1_B3_R2_sort.bam',
    ]
#match smaple,the first sample is Normal sample,the rest one is tumor sample.
#somatic_pair = [['blood04', 'tissue04'], ['blood04', 'xeno04']]

#[output_folder]
Output_Folder = '/gpfs2/home/wanguan2000/result2_NGS/xh/somatic/reuslt_somatic_a3'
#[cpu_no]
cpu = '4'
#[memory]
memory = '-Xmx20g'
