...
somatic('jieguo/b/C3_ALLmerge_realign_mate_recal_raw_indel_filtered.vcf',
        somatic_samples, somatic_pair)
somatic('jieguo/b/C3_ALLmerge_realign_mate_recal_raw_snp_filtered.vcf',
        somatic_samples, somatic_pair)
...
somatic('jieguo/b/C21_ALLmerge_realign_mate_recal_raw_indel_filtered.vcf',
        somatic_samples, somatic_pair)
somatic('jieguo/b/C21_ALLmerge_realign_mate_recal_raw_snp_filtered.vcf',
        somatic_samples, somatic_pair)
...
somatic('jieguo/b/C23_ALLmerge_realign_mate_recal_raw_indel_filtered.vcf',
        somatic_samples, somatic_pair)
somatic('jieguo/b/C23_ALLmerge_realign_mate_recal_raw_snp_filtered.vcf',
        somatic_samples, somatic_pair)
...
somatic('jieguo/b/C27_ALLmerge_realign_mate_recal_raw_indel_filtered.vcf',
        somatic_samples, somatic_pair)
somatic('jieguo/b/C27_ALLmerge_realign_mate_recal_raw_snp_filtered.vcf',
        somatic_samples, somatic_pair)
